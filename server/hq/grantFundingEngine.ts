...
export const IFCDC_FUNDING_DIVISIONS = [
  { slug: "housing", label: "Transitional Housing", programs: ["transitional_housing", "housing", "shelter", "homeless_services"] },
  { slug: "anti_gang", label: "Anti-Gang Program", programs: ["violence_prevention", "community_safety", "gang_prevention", "anti_gang"] },
  { slug: "youth_development", label: "Youth Development", programs: ["youth", "young_adults", "teen", "youth_development"] },
  { slug: "tapis", label: "Mentorship", programs: ["mentorship", "youth_mentorship", "tapis", "mentor"] },
  { slug: "scholarships", label: "Scholarships", programs: ["scholarships", "education", "tuition_assistance"] },
  { slug: "economic_development", label: "Economic Development", programs: ["economic_development", "community_development", "economic_growth"] },
  { slug: "workforce_development", label: "Workforce Development", programs: ["workforce", "job_training", "vocational", "employment"] },
  { slug: "small_business", label: "Small Business Support", programs: ["small_business", "entrepreneurship", "microenterprise", "business_development"] },
  { slug: "community_programs", label: "Community Programs", programs: ["community", "outreach", "neighborhood_services"] },
  { slug: "community_development", label: "Community Development", programs: ["community_development", "cdc", "neighborhood", "revitalization"] },
  { slug: "community_outreach", label: "Community Outreach", programs: ["community_outreach", "engagement", "volunteer", "public_engagement"] },
  { slug: "radio", label: "IFCDC Radio", programs: ["radio", "broadcast", "community_media"] },
  { slug: "productions", label: "IFCDC Productions", programs: ["media", "productions", "film", "video_production"] },
  { slug: "music", label: "IFCDC Music", programs: ["music", "arts", "performing_arts"] },
  { slug: "publishing", label: "IFCDC Publishing", programs: ["publishing", "content", "literacy", "editorial"] },
  { slug: "software_division", label: "IFCDC Software Division", programs: ["technology", "software", "digital_literacy", "app_development"] },
  { slug: "barbers", label: "IFCDC Barbers App", programs: ["barbers", "vocational_training", "workforce", "apprenticeship"] },
  { slug: "technology_infrastructure", label: "Technology Infrastructure", programs: ["technology", "infrastructure", "it_systems", "cybersecurity", "equipment"] },
  { slug: "headquarters", label: "IFCDC Headquarters", programs: ["headquarters", "organizational_capacity", "general_operating", "cdc_operations"] },
  { slug: "aura_ai", label: "AURA AI Assistant", programs: ["artificial_intelligence", "innovation", "digital_transformation", "automation"] },
  { slug: "communications", label: "Communications Center", programs: ["communications", "public_affairs", "marketing", "media_relations"] },
  { slug: "hr_staffing", label: "HR / Staffing / Training", programs: ["staffing", "hiring", "training", "human_resources", "case_management", "professional_development"] },
  { slug: "operations", label: "Operations", programs: ["operations", "logistics", "facilities", "equipment", "fleet"] },
  { slug: "administration", label: "Administration", programs: ["administration", "compliance", "governance", "policy"] },
  { slug: "document_management", label: "Document Management", programs: ["records_management", "document_management", "archives", "information_governance"] },
  { slug: "data_analytics", label: "Data / Analytics", programs: ["data", "analytics", "research", "business_intelligence"] },
  { slug: "financial_management", label: "Financial Management", programs: ["financial_management", "accounting", "fiscal", "audit"] },
  { slug: "nonprofit_capacity", label: "Nonprofit Capacity Building", programs: ["capacity_building", "organizational_development", "nonprofit", "institutional_strengthening"] },
  { slug: "grants_management", label: "Grants Management", programs: ["grants_management", "grant_administration", "federal_compliance"] },
  { slug: "program_evaluation", label: "Program Evaluation", programs: ["evaluation", "outcomes", "impact_measurement", "performance_monitoring"] },
  { slug: "inclusive", label: "Inclusive Community", programs: ["inclusive", "mental_health", "disability_services", "accessibility"] },
] as const;
